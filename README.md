...
- [ ] What are PropTypes used for? Please describe why it's important to type check our data in JavaScript.
    ...
    PropTypes are used to check if the data being used is the right variable type/format. It is important because improper input can throw off your code.

- [ ] Describe a life-cycle event in React?

    A life cycle event in react refers to the timeline of how it renders, re-renders, and dismounts components.

- [ ] Explain the details of a Higher Order Component?

    A higher order component is an advanced React pattern used for designing components that share behavior. It allows you to reuse component logic by recieving another component as an arguement, and returning a new component to the original source, allowing functionality to be added.

- [ ] What are three different ways to style components in React? Explain some of the benefits of each.

    You can use traditional CSS, which Is neater and easier to read

    You can use inline CSS, which is quick but can clutter your code

    You can use Styled-Components, which lets you pass your styling to reusable components, allowing more versitility and ease of use
